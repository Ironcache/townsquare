        ...
        return (
            <div className='col-xs-12'>
                <Panel title='How To Play on Doomtown Online'>
                    ...
                    <a className='btn btn-danger btn-lg pull-right' target='_blank' href='https://discord.com/invite/pine-box-entertainment-643518732999589892'>Join Discord</a>
                    ...
                    <div className='htp-topic'>
                        ...
                        <p>Doomtown Online is still a work in progress. While many cards are implemented and should be working correctly, there are quite a few still to be implemented. We keep a list up to date with unimplemented and partially implemented cards <a target='_blank' href='https://github.com/Ironcache/townsquare/blob/master/docs/cardpool-status.md'>here</a>. If you happen upon a card that you believe is not working as it should and it is marked complete on that list, it would help immensely if you would submit an issue on <a target='_blank' href='https://discord.com/channels/643518732999589892/1442564146070552646'>Discord</a> (<a target='_blank' href='https://discord.com/invite/pine-box-entertainment-643518732999589892'>Join</a>). Other comments and/or feedback can be left on Discord as well.</p>
                    </div>
                    <div className='htp-topic'>
                    ...
                    <div className='htp-topic'>
                        ...
                        <p>There is still a great number of cards that are not scripted and therefore these have to be resolved using <a href='#commands'>Manual Commands</a>. An unscripted card can be identified by the peeking skull on the bottom of the card: <img style={ { width: '20px', height: '22px', 'padding-bottom': '5px' } } src='/img/tokens/scripted_skull.png' /></p>
                        <p>To use an unscripted card, follow these steps:</p>
                        <ul>
